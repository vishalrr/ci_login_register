<?php include('header.php'); ?>
	...
	<section class="dash-sec">
		<div class="container">
			<div class="row">
			    <div class="col-md-12">
    				<div class="btn-sec-link-profile-1 text-left">
    					<a href="" class="btn btn-light-1">Return</a>
    				</div>
				</div>
			</div>
			<div class="row">
			<div class="col-md-7">
						<div class="new-para">
							<p>For 500 dollars 1 can post a -Shout Out" to your brand on any one of my platforms that you would like. An example of an Shout Out that I would complete could be:</p> 
							<p>"Hey Everyone. I want to shout out my friends over at Plushcare today. I have a terrbile cold and didn't want to go anywhere. I love that I can see a REAL doctor from my livingroom while watching I Love Lucy Re-Runs, ofePulshcare I/Someonebringmechickennoodlesoup"</p>
						</div>
						<div class="new-para">
							<h3>Important Due Dates 
							<!-- Button trigger modal -->
							  <i class="far fa-plus-square btn btn-light-2 icon-style" data-toggle="modal" data-target="#exampleModal-1"></i></h3>
                    ...
                    <span aria-hidden="true">×</span>
								  ...
								  <div class="col-md-12">
										<h5 class="modal-title modal-t" id="exampleModalLabel-1">Add a Milestone</h5>
									</div>
								  ...
								  <div class="row">
										...
										<div class="col-md-10 modal-btn-text">
                                              <span>Type the Milestone</span>
                                              <div class="input-modal-custom">
                                                   <div class="input-group mb-3 mb-new-width">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-dollar-sign"></i></span>
                                                     </div>
                                                    <input type="text" class="form-control date-custom" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
                                                 </div>
                                              </div>
                                              <span>Add the due Date</span>
                                              <div class="input-modal-custom">
                                                <div class="input-group mb-3 mb-new-width">
                                                    <div class="input-group-prepend">
                                                     <span class="input-group-text" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>
                                                    </div>
                                                    <input type="text" class="form-control border-0 rounded-0" placeholder="" autocomplete="off" name="text" id="datepicker7">
                                                 </div>
                                           </div>  
										</div>
										<div class="col-md-1"></div>
								  ...
								  <div class="modal-footer">
								      ...
								      <div class="col-md-12 text-center"><button type="button" class="btn btn-light-3 mb-3">Add New Milestone</button>
								     <button type="button" class="btn btn-light-3 mb-3" data-dismiss="modal">Save & Close</button></div>
								...
								<div class="row input-sec-1">
								   <div class="col-md-6 head-part">
								      <h5>Concept Apporval</h5> </div>
								    <div class="col-md-6">
								        <div class="input-group mb-3 mb-new-width">
                                            <div class="input-group-prepend">
                                             <span class="input-group-text" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>
                                            </div>
                                            <input type="text" class="form-control border-0 rounded-0 new-input" placeholder="" autocomplete="off" name="text" id="datepicker8">
                                         </div>
                                    </div>  
                                    <div class="col-md-6 head-part">
								      <h5>Hashtag and Caption Approval</h5> </div>
								    <div class="col-md-6">
								        <div class="input-group mb-3 mb-new-width">
                                            <div class="input-group-prepend">
                                             <span class="input-group-text" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>
                                            </div>
                                            <input type="text" class="form-control border-0 rounded-0 new-input" placeholder="" autocomplete="off" name="text" id="datepicker9">
                                         </div>
                                    </div> 
                                    <div class="col-md-6 head-part">
								      <h5>Final Post Approval</h5> </div>
								    <div class="col-md-6">
								        <div class="input-group mb-3 mb-new-width">
                                            <div class="input-group-prepend">
                                             <span class="input-group-text" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>
                                            ...
                                            <input type="text" class="form-control border-0 rounded-0 new-input" placeholder="" autocomplete="off" name="text" id="datepicker10">
                                         </div>
                                    </div> 
                                    <div class="col-md-6 head-part">
								      <h5>Job Completion Date</h5> </div>
								    <div class="col-md-6">
								        <div class="input-group mb-3 mb-new-width">
                                            <div class="input-group-prepend">
                                             <span class="input-group-text" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>
                                            </div>
                                            <input type="text" class="form-control border-0 rounded-0 new-input" placeholder="" autocomplete="off" name="text" id="datepicker11">
                                         </div>
                                    </div> 
                                    
                                    <div class="col-md-12 col-12 head-part">
                		                <div class="container-1" role="main">
                						<form method="" action="" enctype="" novalidate class="box">
					 ...
					 <div class="row">
    		            ...
    		            <div class="col-md-6">
		                    <div class="col-md-12 offer-box-job"> 
        					    <div class="box-offer-1"> 
            						 <h2>$350</h2> 
            						 <h6 class="out">Shout Out</h6> 
            					 </div> 
    				        </div> 
		                </div>
	            </div>
			...
			<!--<div class="row justify-content-center h-100">-->
				<!--<div class="col-md-12 col-xl-12 chat">-->
					<div class="card">
						...
						<div class="card-body msg_card_body mCustomScrollbar">
		...
		<!--		<div class="col-md-5">-->
				 <!--   <div class="btn-sec-link-profile-1">-->
						<!-- Button trigger modal -->
					<!--		<button type="button" class="btn btn-light-1" data-toggle="modal" data-target="#exampleModal">-->
					<!--		  Customize Pricing-->
					<!--		</button>-->
					...
					<!--			  <div class="col-md-8">-->
					<!--					<h5 class="modal-title" id="exampleModalLabel">Customize Offer</h5>-->
					<!--				</div>-->
					<!--			  <div class="col-md-2"></div>-->
					<!--			  </div>-->
					<!--			  <div class="modal-body">-->
					<!--			  <div class="row">-->
					<!--					<div class="col-md-2"></div>-->
					<!--					<div class="col-md-8 modal-btn-text">-->
					<!--						<div class="pd-top">-->
					<!--						<h4>Current Price : $500</h4></div>-->
					<!--						<div class="pd-top">-->
					<!--						<h4> New Price : $350</h4>-->
					<!--						</div>-->
					<!--					</div>-->
					...
					<!--			  </div>-->
					<!--			  <div class="modal-footer">-->
					<!--						<button type="button" class="btn btn-light-1">Save changes</button>-->
					<!--					<button type="button" class="btn btn-light-1" data-dismiss="modal">Close</button>-->
										
					<!--			</div>-->
					<!--		</div>-->
					<!--	</div>-->
					<!--</div>-->
					<!--	<button type="button" class="btn btn-light-1">Accept Job</button>-->
					<!--	<button type="button" class="btn btn-light-1">Complete Job</button>-->
					<!--</div>-->
		<!--		</div>-->
		<!--</div>-->
				
	</section>
	<section class="bottom-btn-job">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<div class="btn-sec-link-profile-1">
						...
						<button type="button" class="btn btn-light-1">Pay Now</button>
						<button type="button" class="btn btn-light-1">Approve Completed Job</button>
					</div>
				</div>
			</div>
		</div>
    ...
    <div class="modal-dialog" role="document">
		<div class="modal-content">
		    ...
		    <div class="modal-header">
		        ...
		        <div class="col-md-12">
			        <h5 class="modal-title modal-t" id="exampleModalLabel-1">Customize Offer</h5>
		    	</div>
		    ...
		    <div class="modal-footer">
				<button type="button" class="btn btn-light-3" data-dismiss="modal">Save & Close</button>
		    </div>
		</div>
	</div>
</div>	
...
<script>
  ...
  <script>
  $( function() {
    $( "#datepicker7,#datepicker8,#datepicker9,#datepicker10,#datepicker11" ).datepicker();
  } );
  </script>
