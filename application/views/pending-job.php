		...
		<div class="container">
			<div class="row">
			    <div class="col-md-12">
    				<div class="btn-sec-link-profile-1 text-left">
    					<a href="user" class="btn btn-light-1">Return to Dashboard</a>
    				</div>
				</div>
			</div>
			...
			<div class="col-lg-7 col-md-12 ">
						<div class="new-para">
							...
							<p>"Hey Everyone. I want to shout out my friends over at Plushcare today. I have a terrbile cold and didn't want to go anywhere. I love that I can see a REAL doctor from my livingroom while watching I Love Lucy Re-Runs, ofePulshcare I/Someone bring me chicken noodle soup"</p>
						</div>
						<div class="new-para">
							  ...
							  <div class="modal-dialog" role="document">
								<div class="modal-content modal-date">
								  ...
								  <div class="modal-footer">
								      ...
								      <div class="col-md-12"><button type="button" class="btn btn-light-3">Add New Milestone</button>
								     <button type="button" class="btn btn-light-3" data-dismiss="modal">Save & Close</button></div>
					...
					<div class="row input-sec-1">
					   <div class="col-md-6 col-sm-12 head-part">
					      <h5>Concept Apporval</h5> 
                        ...
                        <div class="col-md-6 col-sm-12 head-part">
					      <h5>Hashtag and Caption Approval</h5> 
					        <div class="input-group mb-3 mb-new-width">
                                <div class="input-group-prepend">
                                 <span class="input-group-text" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>
                                </div>
		...
		<div class="container">
			...
			<div class="col-md-1"></div>
				<div class="col-md-10">
					...
					<a href="user" class="btn btn-light-1">Accept Job</a>
						<a href="user" class="btn btn-light-1">Complete Job</a>
					</div>
				</div>
				<div class="col-md-1"></div>
			</div>
