			  ...
			  <div class="row breadcrumbs-top d-inline-block pull-left">
				<div class="breadcrumb-wrapper col-12">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="traininginstitute.php">Edit Placement Training / Institutes</a>
					</li>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
						  <h4 class="card-title" id="basic-layout-form-center">Placement Training / Institutes</h4>
						 
						</div>
						<div class="card-content collapse show">
							<div class="card-body">
								<div class="">
									<h4 class="sb-ttl">Add New Institute</h4>
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
											  <label for="eventInput1">Institute Name</label>
											  <input type="text" class="form-control" placeholder="" name="Name" value="Taxmaster">
											...
											<div class="form-group">
											  <label for="eventInput1">	Category </label>
												<select class="form-control">
													...
													<option value="18" selected> Accounting/Taxation </option>
										...
										<div class="col-md-4">
											<div class="form-group">
											  <label for="eventInput1">Institute Profile</label>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control">
													...
													<option value="7" selected>   Albania </option>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control">
													...
													<option value="212" selected>Antwerpen</option>
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="www.abc.com" />
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label for="eventInput1">Institute Logo</label>
