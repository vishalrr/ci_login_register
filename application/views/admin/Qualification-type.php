     ...
     <div class="content-header row">
          ...
          <div class="row breadcrumbs-top d-inline-block pull-left">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a>Job Qualification</a>
                </li>
      ...
      <div class="content-body">
          <?php include('inc/message.php'); ?>
			  ...
			  <strong>Success !</strong> You have succesfully deleted this Qualification
			</div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Job Qualification
					<span class="pull-right"><a href="<?php echo base_url(); ?>admin/job/add-qualification-type" class="btn btn-primary btn-sm"> Add New	 </a> </span>
                 </h4>
                </div>
                  ...
                  <div class="card-body card-dashboard">
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
						<thead>
							<tr>
								<th>S.No</th>
								<th style="width:60%;">Job Qualifications</th>
								    ...
								    <?php /*if($cat->status==1){ 
        						 	   ...
        						 	   if($cat->status==0){ 
        						 	    $title = "Inactive"; 
        						 	     ...
        						 	     <input type="checkbox" class="switchBootstrap swtch" action="<?php echo base_url();?>admin/Employer/statusupdate" data-id="<?php echo $cat->id; ?>" data-tbl="qualification"  data-off-text="Inactive" data-on-text="Active" <?= ($cat->status=='1') ? 'checked' : ''; ?> />
									<a href="add-qualification-type?id=<?php echo $cat->id; ?>" class="btn btn-warning btn-table" ><i class="la la-pencil"></i></a>
									
									<!--<?php if($cat->status==1){ ?>
        						 	 	<a href="javascript:void(0)" action="<?php echo base_url(); ?>admin/status" data-id="<?php echo $cat->id; ?>" data-status="<?php echo $cat->status; ?>" data-tbl="qualification" class="btn btn-success btn-table status" data-toggle="modal" data-title="<?php echo $title; ?>" title="<?php echo $title; ?>" data-target="#Status"><i class="fa fa-toggle-on"></i></a>
        						 	   <?php } 
        						 	   if($cat->status==0){ ?>
        						 	   	<a href="javascript:void(0)" action="<?php echo base_url(); ?>admin/status" data-id="<?php echo $cat->id; ?>" data-status="<?php echo $cat->status; ?>" data-tbl="qualification" class="btn btn-danger btn-table status" data-toggle="modal" data-title="<?php echo $title; ?>" title="<?php echo $title; ?>" data-target="#Status"><i class="fa fa-toggle-off"></i></a>
        						 	  <?php  } ?>
								-->
									
									<a href="javascript:void(0)" action="<?php echo base_url(); ?>admin/job/delete" data-id="<?php echo $cat->id; ?>" data-tbl="qualification" class="btn btn-danger btn-table dlt" data-toggle="modal" data-target="#delete"><i class="la la-trash"></i></a>
								</td>
							</tr>
							<?php } ?>
							<!--tr>
