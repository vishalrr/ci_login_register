            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Edit Language
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  <label for="eventInput1"> Add Language Code <sup> * </sup>	</label>
									  <input type="text" class="form-control" placeholder="" name="fullname" value="AR">
									 
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
									  <label for="eventInput1"> Add Language Name <sup> * </sup>	</label>
									  <input type="text" class="form-control" placeholder="" name="fullname" value="Arabic">
					...
					<h5 class="main-ttl-n m-t-30"> Language List</h5>
