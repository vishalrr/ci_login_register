    ...
    <div class="content-wrapper">
     <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
		  ...
		  <a class="pull-right content-header-title no-space" href="statelist.php"> <i class="la la-angle-left set-it"></i> Back</a>
        </div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
						  <label for="eventInput1">Add City   </label>
						  <input type="text" class="form-control" placeholder="City Name" name="fullname" value="">
						</div>
					</div>
					<!--div class="col-md-12">
			...
			<div class="col-md-12">
			  <div class="form-body">
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
						  <label for="eventInput1">City Name   </label>
						  <input type="text" class="form-control" placeholder="Category Name" name="fullname" value="Damarkaj">
						</div>
					</div>
					<!--div class="col-md-12">
						<div class="form-group forms-radio">
