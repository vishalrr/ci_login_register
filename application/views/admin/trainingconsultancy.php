                ...
                <div class="card-header">
					<h4 class="card-title">
						...
						<span class="pull-right">
							<a href="add-trainingconsultancy.php" class="btn btn-primary btn-sm"> Add New </a> 
						</span>
					</h4>
                </div>
                  ...
                  <div class="card-body card-dashboard">
					...
					<table class="table table-striped table-bordered file-export">
                      <thead>
                        <tr>
                          <th>S.No</th>
                          <th>Consultany Name</th>
                          <th>Consultany Logo</th>
                          <th>Category</th>
                          <th>Type</th>
                          <th>Contact</th>
                          <th>Website URL</th>
                      ...
                      <tbody>
                        <tr>
						  ...
						  <a href="edit-trainingconsultancy.php" class="btn btn-warning btn-table"><i class="la la-pencil"></i></a>
