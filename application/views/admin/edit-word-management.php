            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-form-center">Edit words</h4>
                        ...
                        <div class="col-md-12">
                          <div class="form-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  <label for="eventInput1">Edit Language <sup> * </sup>	</label>
									  <select class="form-control">
										<option>Select Language</option>
										<option value="2" selected="">Arabic</option>
									...
									<div class="form-group">
									  <label for="eventInput1">Add Page <sup> * </sup>	</label>
										 <select class="form-control">
											   ...
											   <option value="55" selected="">emp_resume_pack.php</option>
							...
							<div class="row">
									...
									<div class="form-group">
									  <label for="eventInput1">Add pre_words<sup> * </sup>	</label>
										 <select class="form-control">
											  ...
											  <option value="939" selected="">vidhya</option>
								...
								<div class="col-md-6">
									<div class="form-group">
									  <label for="eventInput1">Edit Word<sup> * </sup>	</label>
										<input type="text" class="form-control" value="قائمة الوظائف المتاحة">
									</div>
								</div>
							</div>
