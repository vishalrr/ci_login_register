        ...
        <div class="sidebar-content email-app-sidebar d-flex">
          <div class="email-app-menu col-md-5 card d-none d-lg-block">
            ...
            <div class="list-group list-group-messages">
              ...
              <a href="<?php echo base_url();?>admin/starred" class="list-group-item active list-group-item-action border-0"><i class="ft-star mr-1"></i> Starred<span class="badge badge-danger badge-pill float-right">3</span> </a>
                    ...
                    <table id="inbox-mail" class="table table-white-space table-bordered display no-wrap icheck table-middle" style="padding: 0 !important;">
                      ...
                      <tbody>
                        ...
                        <tr class="unread">
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: JohnSmith, Shelton</td>
                          <td class="clickable-row" data-href="viewmail.php">Update of REC Social Media...</td>
                          <td>Aug 23</td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: Davikulkar, Somnath</td>
                          <td class="clickable-row" data-href="viewmail.php">This mail is regarding to your account update of behance, please...</td>
                          <td>Aug 22</td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: JohnSmith</td>
                          <td class="clickable-row" data-href="viewmail.php">Changing your life with me and I hope you will growth in your...</td>
                          <td>Aug 15</td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: JohnSmith, Shelton</td>
                          <td class="clickable-row" data-href="viewmail.php">Perera was the PM of your choice so...</td>
                          <td>Aug 14</td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: JohnSmith, Shelton</td>
                          <td class="clickable-row" data-href="viewmail.php">Nobody tell me that you'r a expert in UI/UX...</td>
                          <td>Aug 13</td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: JohnSmith, Shelton</td>
                          <td class="clickable-row" data-href="viewmail.php">Summary of behavior</td>
                          <td>Aug 10</td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: JohnSmith, Shelton</td>
                          <td class="clickable-row" data-href="viewmail.php">Continue to biggest discount of every amazone product...</td>
                          <td>Aug 9</td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td class="clickable-row" data-href="viewmail.php">To: JohnSmith, Shelton</td>
                          <td class="clickable-row" data-href="viewmail.php">Want to change your life, join me soon...</td>
                          <td>Aug 8</td>
                        </tr>
                        <tr>
                          <td>
