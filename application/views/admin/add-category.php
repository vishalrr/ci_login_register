          ...
          <div class="row breadcrumbs-top d-inline-block pull-left">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Add New Category
</a>
                </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-form-center">Add New Category</h4>
                 
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <h5 class="main-ttl-n"> Add New Category </h5>
                    <form class="form">
