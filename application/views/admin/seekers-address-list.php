          ...
          <div class="row breadcrumbs-top d-inline-block pull-left">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Seekers  Address List
</a>
                </li>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Seekers  Address List
				</h4>
                </div>
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>sudipta</td>
								<td>e10adc3949ba59abb</td>
								<td>sudiptapal88@gmail.com	</td>
								<td>12 </td>
								<td>Arambag </td>
							...
							<tr>
								<td>2</td>
								<td>rajuramk</td>
								<td>e10adc3949ba59</td>
								<td>rajuramk@mtoag.com		</td>
								<td> </td>
								<td> Ramgarh </td>
							
								<td>+1345 5466 6557 </td>
								<td> 9887506812</td>
							</tr>
							<tr>
								<td>3</td>
