          ...
          <div class="row breadcrumbs-top d-inline-block pull-left">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Add New Company
</a>
                </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-form-center">Add New Company</h4>
                 
                </div>
                <div class="card-content collapse show">
                  <div class="card-body">
                    <h5 class="main-ttl-n"> Add New Company </h5>
                    <form class="form">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  <label for="eventInput1">Company Name <sup> * </sup>	</label>
									...
									<div class="form-group">
									  <label for="eventInput1">Company Type<sup> * </sup>		</label>
										<select class="form-control">
											...
											<option value="175">IT Company</option>
