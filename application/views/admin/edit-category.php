          ...
          <div class="row breadcrumbs-top d-inline-block pull-left">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Edit Category
</a>
                </li>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <h5 class="main-ttl-n"> Edit Category </h5>
                    <form class="form">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  <label for="eventInput1">Edit Category Name <sup> * </sup>	</label>
									  <input type="text" class="form-control" placeholder="" name="fullname" value="GD">
