          ...
          <div class="row breadcrumbs-top d-inline-block pull-left">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Discussion Details</a>
                </li>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
						...
						<tbody>
							<tr>
								...
								<td><a href="discussion-replies.php"> testing</a></td>
								<td><a href="discussion-replies.php"> 2</a></td>
								<td>18-01-2014</td>
								<td>
					...
					<h5 class="main-ttl-n m-t-30"> Inactive Discussion </h5>
					<div class="table-responsive">
                    <table class="table table-striped table-bordered zero-configuration">
						<thead>
							<tr>
