			...
			<div class="row breadcrumbs-top d-inline-block pull-left">
				<div class="breadcrumb-wrapper col-12">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#">Sub Administrator User</a></li>
					</ol>
				</div>
			</div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Sub Administrator User
					<span class="pull-right"><a href="add-sub-administrator-members.php" class="btn btn-primary btn-sm"> Add New </a> </span>
                 </h4>
                </div>
                      ...
                      <thead>
						...
						<tbody>
							<tr>
								...
								<td>Moderate</td>
								<td>
									<a href="edit-sub-administrator-members.php" class="btn btn-warning btn-table"><i class="la la-pencil"></i></a>
