          ...
          <div class="row breadcrumbs-top d-inline-block pull-left">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Add Placement Papers	</a>
                </li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-form-center">Add Placement Papers</h4>
									...
									<div class="form-group">
									  <label for="eventInput1">Categories 	</label>
										<select class="form-control">
											...
											<option value="339">Banking</option>
