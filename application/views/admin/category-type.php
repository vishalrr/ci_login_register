     ...
     <div class="content-header row">
      ...
      <div class="content-body">
          <?php include('inc/message.php'); ?>
			  ...
			  <strong>Success !</strong> You have succesfully deleted this category
			</div>
              ...
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Categories
					<span class="pull-right"><a href="<?php echo base_url(); ?>admin/job/add_category_type" class="btn btn-primary btn-sm"> Add New	 </a> </span>
                 </h4>
                </div>
								    ...
								    <?php /*if($cat->status==1){ 
        						 	   ...
        						 	   if($cat->status==0){ 
        						 	    $title = "Inactive"; 
        						 	     ...
        						 	     <input type="checkbox" class="switchBootstrap swtch" action="<?php echo base_url();?>admin/Employer/statusupdate" data-id="<?php echo $cat->id; ?>" data-tbl="categorys"  data-off-text="Inactive" data-on-text="Active" <?= ($cat->status=='1') ? 'checked' : ''; ?> />
									<a href="add-category-type?id=<?php echo $cat->id; ?>" class="btn btn-warning btn-table" ><i class="la la-pencil"></i></a>
										
									<a href="javascript:void(0)" action="<?php echo base_url(); ?>admin/job/delete" data-id="<?php echo $cat->id; ?>" data-tbl="categorys" class="btn btn-danger btn-table dlt" data-toggle="modal" data-target="#delete"><i class="la la-trash"></i></a>
								</td>
							</tr>
							<?php } ?>
							<!--tr>
