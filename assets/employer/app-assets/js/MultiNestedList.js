...
$('ul.tree-new').each(function(){
  $this = $(this);
  $this.find("li").has("ul").addClass("hasSubmenu");
});
// Find the last li in each level
$('ul.tree-new li:last-child').each(function(){
  $this = $(this);
...
$('ul.tree-new li.hasSubmenu').each(function(){
  $this = $(this);
  $this.prepend("<a href='#'><i class='my_minus fa fa-minus-circle'></i><i style='display:none;' class='fa fa-plus-circle'></i></a>");
  $this.children("a").not(":last").removeClass().addClass("toogle");
});
// Actions to expand and consense
$('ul.tree-new li.hasSubmenu a.toogle').click(function(){
  $this = $(this);
